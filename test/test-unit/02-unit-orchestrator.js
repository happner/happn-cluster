...
describe(filename, function() {
  ...
  context("new logging function: checkMembersAndLogClusterHealth", () => {
    it("tests the checkMembersAndLogClusterHealth when no members or peers are configured", done => {
      var o = new Orchestrator(mockOpts);
      o.log.info = msg => {
        expect(msg).to.be("Cluster Healthy");
        done();
      };
      o.checkMembersAndLogClusterHealth();
    });

    it("tests the checkMembersAndLogClusterHealth will report Healthy when peers == members are configured", done => {
      var o = new Orchestrator(mockOpts);
      o.log.info = msg => {
        expect(msg).to.be("Cluster Healthy");
        done();
    ...
    it("tests the checkMembersAndLogClusterHealth will remove a non-swim-connected, non-member peer and report Healthy", done => {
      var o = new Orchestrator(mockOpts);
      o.log.info = msg => {
        if (msg === "Cluster Healthy") {
          expect(o.peers).to.eql({
            memberName: {
              name: "memberName",
              clusterName: "cluster-name",
              memberId: "id",
    ...
    it("tests the checkMembersAndLogClusterHealth will call __stateUpdate when there is a  connected nonMember-Peer", done => {
      var o = new Orchestrator(mockOpts);
      o.log.warn = msg => {
        expect(msg).to.be(
          "Lost happn connection to swim connected peer: memberName2, will attempt state update "
        );
      };
      o.__stateUpdate = done;
      o.members = {
        id: {
          name: "memberName",
          clusterName: "cluster-name",
    ...
    it("tests the checkMembersAndLogClusterHealth will call __stateUpdate when there is a loggedIn nonMember-Peer", done => {
      var o = new Orchestrator(mockOpts);
      o.log.warn = msg => {
        expect(msg).to.be(
          "Lost happn connection to peer from login : memberName2, attempting reconnection"
        );
      };
      o.__stateUpdate = done;
      o.members = {
    ...
    it("tests the checkMembersAndLogClusterHealth will call __stateUpdate when there is a non-Peer member", done => {
      var o = new Orchestrator(mockOpts);
      o.log.warn = msg => {
        expect(msg).to.be(
          "Lost happn connection to peer from login : memberName2, attempting reconnection"

...
Member.prototype.stop = Promise.promisify(function (callback) {
  ...
  // this.client.disconnect() also removes these subscriptions
  try {
  ...
  var cleanupAndCallback = function (e) {
    ...
    _this.client.socket.destroy(); // primus reconnect persists unless this...???
    delete _this.client;
    callback(e);
  };

  this.client.disconnect(cleanupAndCallback);

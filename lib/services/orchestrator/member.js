...
Member.prototype.stop = Promise.promisify(function (callback) {
  ...
  console.log('DISCONNECTING HAPPN CLI:::');

  if (this.connectedTo) return this.client.disconnect(function (e) {

    if (e) console.log('DISCONNECTING HAPPN CLI FAILED:::', e);

    delete _this.client;
    callback(e);
  });

  console.log('OK NOT CONNECTED TO:::');
  ...
  this.client.pubsub.on('destroy', cleanupAndCallback);

...
var Orchestrator = require('./orchastrator');
var getAddress = require('./get-address');


module.exports.create = Promise.promisify(function(config, callback) {
  var happn, error, membership, orchestrator, dataPlugin, happnAddress;
  ...
  Happn.service.create(config)
    ...
    .then(function(_happn) {
      ...
      orchestrator = new Orchestrator(happn);
      happn.orchestrator = orchestrator;
    ...
    .then(function() {
      ...
      // 0.0.0.0 won't do
      var protocol = happn.config.transport.mode;
